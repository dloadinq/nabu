...
public static class ModelManager
{
    ...
    public static string? PromptModelSize(string modelsDirectory, GpuInfo gpuInfo)
    {
    ...
    public static async Task<(string FilePath, LoadedModelInfo ModelInfo)> EnsureModelAsync(
        string modelSize, string modelsDirectory, GpuInfo gpuInfo)
    {
        ...
        var resolution = ResolveModel(modelInfo, gpuInfo);
    ...
    private static ModelResolution ResolveModel(ModelInfo modelInfo, GpuInfo gpuInfo)
    {
        if (!gpuInfo.IsGpu)
